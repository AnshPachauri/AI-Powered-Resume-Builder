...
export interface PersonalInfo {
  ...
  website: string;
  profession: string;
  image: string; // can be string path to image
}
    ...
    experience: [
      {
        ...
        start_date: "2023-06",
        end_date: "Present",
        description: "Architected, developed, and deployed innovative full-stack applications at Example Technologies. creating robust back-end systems and intuitive front-end interfaces.",
        is_current: true,
      ...
      },
      {
        ...
        start_date: "2019-08",
        end_date: "2023-05",
        description: "Engineered and deployed scalable full-stack web applications, translating complex requirements into robust front-end interfaces and efficient back-end services.",
        is_current: false,
  ...
  },
  {
    ...
    experience: [
      ...
      },
      {
        ...
        start_date: "2018-09",
        end_date: "2022-01",
        description: "Developed reusable UI components using React and Vue.js.",
        is_current: false,
