...
const CreateCard = ({ image, name, handle, date }: CardProps) => (
...
const Testimonial = () => {
  ...
  return (
    <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12">
      {/* Section Header */}
      <div className="flex items-center gap-2 text-sm text-indigo-500 bg-indigo-400/10 border border-indigo-200 rounded-full px-4 py-1">
        <BookUserIcon className="size-6 stroke-indigo-600" width={14} />
